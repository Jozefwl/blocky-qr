...
\begin{frame}{Prečo práve \texttt{qr-blocky}?}
  \begin{itemize}
    ...
    \item Backend má qr-app endpoint, každé volanie sa zaznamenáva do \textbf{auditloguje} (request log).
...
\begin{frame}{Cesta k Big Data architektúre}
  \begin{enumerate}
    ...
    \item Pri extrémnych objemoch: \textbf{computation module per channel}\,-\,vlastná queue a vlastná skupina workerov pre každý RabbitMQ channel.
    \item Deployment ako \textbf{KEDA job}\,-\,dynamické škálovanie podľa dĺžky fronty, napr. v \textbf{Azure} (AKS + KEDA).
  \end{enumerate}
\end{frame}
